...
d3.csv("./data/one-year-of-recipes.csv", parseCSV).then(function(data) {
    ...
    */
   //intentionally not grabbing all possible porperties from original dataset
   //creating an array of nodes to use for the force layout
    var nodes = [];
...
console.log(nodes);
    ...
    */
    ...
    //create a data structure for how nodes are connected
    //nodes are connected if they share common ingredients in the recipes
    //nested for loop that starts 1 ahead of the outermost for loop
    //grab the first recipe you're going to compare and its ingredients
