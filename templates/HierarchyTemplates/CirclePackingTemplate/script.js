...
//.rollup calculates the number of instances of each offense code group, and it sets the value of those unique instances
//.sort is for sorting arrays, comparing pairs of arrays by their lengths, bumping the larger ones toward the top of the array
   var nested = d3.nest()
    ...
    */
   //.slice takes an input array and creates a subset

   var nested = nested.slice(0,10);
   console.log(nested);
    ...
    */
    ...
    //.padding detrmines the space between the circles in the pack
    ...
    */
    ...
    //uses d.values as the child accessor
    //anywhere it finds a property named values, it will treat it as a collection of children 
    //node size determined by value
