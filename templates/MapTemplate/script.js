...
Promise.all(promises).then(function(data) {
    ...
    */
    ...
    function updateMap(year) {
        ...
        //set cx and cy for tooltip, set tooltip visibility
        //set html content of tooltip using <br> to create line breaks
...
*/
//.getFullYear() is a JS method working with the date object
