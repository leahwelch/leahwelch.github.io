...
Z.makeData=I;Z.makeTable=function(a){const b={};a=Object.entries(a);for(const [c,d]of a)b[c]=bf(d);return new X(b)};Z.makeVector=bf;Z.tableFromArrays=function(a){const b={};a=Object.entries(a);for(const [c,d]of a)b[c]=qi(d);return new X(b)};Z.tableFromIPC=function(a){const b=Sj.from(a);return m(b)&&l(b.then)?(async()=>new X(await (await b).readAll()))():new X(b.readAll())};Z.tableFromJSON=function(a){a=qi(a);a=new W(new R(a.type.children),a.data[0]);return new X(a)};
Z.tableToIPC=function(a,b="stream"){return("stream"===b?Ak:Bk).writeAll(a).toUint8Array(!0)};Z.util=Ok;Z.vectorFromArray=qi;Object.assign(arguments[0],Z);}.bind(this))));
