//var introWidth = document.querySelector("#sources").clientWidth;
//var introHeight = document.querySelector("#sources").clientHeight;
var sourceMargin = {top: 0, left: 150, right: 150, bottom: 75};

var svgSources = d3.select("#intropics")
    .append("svg")
    .attr("width", 1000)
    .attr("height", 1500);

var eCommerceLabel = svgSources.append("text")
    .attr("x", sourceMargin.left)
    .attr("y", sourceMargin.top+25)
    .style("font-size", 18)
    .style("visibility", "visible")
    .text("eCommerce");

var eastDanePic = svgSources.append("image")
    .attr("xlink:href", "./pictures/eastDane.jpg")
    .attr("x", sourceMargin.left)
    .attr("y", sourceMargin.top+40);

var eastDaneLabel = svgSources.append("svg:a")
    .attr("xlink:href", "https://www.eastdane.com/traffic-zip-polo-obey/vp/v=1/1596051638.htm?folderID=19396&colorId=10C4D")
    .append("text")
        .attr("x", sourceMargin.left)
        .attr("y", sourceMargin.top+460)
        .style("font-size", 14)
        .attr("class", "linktext")
        .style("visibility", "visible")
        .text("East Dane");

var zaraPic = svgSources.append("image")
    .attr("xlink:href", "./pictures/zara.jpg")
    .attr("x", 400)
    .attr("y", sourceMargin.top+40);

var zaraLabel = svgSources.append("svg:a")
    .attr("xlink:href", "https://www.zara.com/us/en/metallic-thread-jacket-p06540122.html?v1=38313610&v2=1283270")
    .append("text")
        .attr("x", 400)
        .attr("y", sourceMargin.top+460)
        .style("font-size", 14)
...
var ralphPic = svgSources.append("image")
    .attr("xlink:href", "./pictures/ralphLauren.jpg")
    .attr("x", 650)
    .attr("y", sourceMargin.top+40);

var ralphLabel = svgSources.append("svg:a")
    .attr("xlink:href", "https://www.ralphlauren.com/men-clothing/packable-quilted-down-jacket/489754.html?cgid=men-clothing&dwvar489754_colorname=Cruise%20Navy&webcat=Men%2FClothing#start=1&cgid=men-clothing")
    .append("text")
        .attr("x", 650)
        .attr("y", sourceMargin.top+460)
        .style("font-size", 14)
...
var streetLabel = svgSources.append("text")
    .attr("x", sourceMargin.left)
    .attr("y", sourceMargin.top+525)
    .style("font-size", 18)
    .style("visibility", "visible")
    .text("Street Style");

var stuPic = svgSources.append("image")
    .attr("xlink:href", "./pictures/street1.jpg")
    .attr("x", sourceMargin.left)
    .attr("y", sourceMargin.top+540);

var stuLabel = svgSources.append("svg:a")
    .attr("xlink:href", "https://www.fashionbeans.com/2019/stu/")
    .append("text")
        .attr("x", sourceMargin.left)
        .attr("y", sourceMargin.top+960)
        .style("font-size", 14)
        .attr("class", "linktext")
        .style("visibility", "visible")
...
var samPic = svgSources.append("image")
    .attr("xlink:href", "./pictures/street2.jpg")
    .attr("x", 400)
    .attr("y", sourceMargin.top+540);

var samLabel = svgSources.append("svg:a")
    .attr("xlink:href", "https://www.fashionbeans.com/2019/sam-15/")
    .append("text")
        .attr("x", 400)
        .attr("y", sourceMargin.top+960)
        .style("font-size", 14)
...
var nicPic = svgSources.append("image")
    .attr("xlink:href", "./pictures/street3.jpg")
    .attr("x", 650)
    .attr("y", sourceMargin.top+540);

var nicLabel = svgSources.append("svg:a")
    .attr("xlink:href", "https://www.fashionbeans.com/2019/nic-2/")
    .append("text")
        .attr("x", 650)
        .attr("y", sourceMargin.top+960)
        .style("font-size", 14)
