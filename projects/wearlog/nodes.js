...
d3.csv("./data/wearlog.csv", parse).then(function(data) {
    ...
    for(let i = 0; i < data.length; i++) {
        colors.push({color: data[i].hex1, date: data[i].date})
        colors.push({color: data[i].hex2, date: data[i].date})
        colors.push({color: data[i].hex3, date: data[i].date})
        colors.push({color: data[i].hex4, date: data[i].date})
        colors.push({color: data[i].hex5, date: data[i].date})
    }
